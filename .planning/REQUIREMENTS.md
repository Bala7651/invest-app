...
- [x] **WTCH-06**: Each watchlist card shows a sparkline mini chart of the day's price trend
...
- [x] **UI-03**: Responsive layout for Android devices
...
- [x] **AI-12**: Portfolio health — user inputs share quantities per watchlist stock; app calculates total invested value, sector concentration (%), AI analyses correlation clusters and writes an overall portfolio health score and outlook; holdings persist in SQLite
